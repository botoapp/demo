...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"PrivateRoutes\", function() { return PrivateRoutes; });\n/* harmony import */ var _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/auth/RouteGuard */ \"./src/auth/RouteGuard.ts\");\n\nvar PrivateRoutes = [\n    {\n        path: \"/editor/:id?\",\n        name: \"home.editor\",\n        component: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, /*! @/modules/Editor/index.vue */ \"./src/modules/Editor/index.vue\")); },\n        beforeEnter: _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__[\"routeGuard\"],\n    },\n    {\n        path: \"/dashboard\",\n        name: \"home.dashboard\",\n        component: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, /*! @/modules/Dashboard/index.vue */ \"./src/modules/Dashboard/index.vue\")); },\n        beforeEnter: _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__[\"routeGuard\"],\n    },\n    {\n        path: \"/botos\",\n        name: \"home.botos\",\n        component: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! @/modules/Botos/index.vue */ \"./src/modules/Botos/index.vue\")); },\n        beforeEnter: _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__[\"routeGuard\"],\n    },\n    {\n        path: \"/faq\",\n        name: \"home.faq\",\n        component: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, /*! @/modules/Faq/index.vue */ \"./src/modules/Faq/index.vue\")); },\n        beforeEnter: _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__[\"routeGuard\"],\n    },\n    {\n        path: \"/contact\",\n        name: \"home.contact\",\n        component: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(5)]).then(__webpack_require__.bind(null, /*! @/modules/Contact/index.vue */ \"./src/modules/Contact/index.vue\")); },\n        beforeEnter: _auth_RouteGuard__WEBPACK_IMPORTED_MODULE_0__[\"routeGuard\"],\n    },\n];\n\n\n//# sourceURL=webpack:///./src/routes/PrivateRoutes.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"PublicRoutes\", function() { return PublicRoutes; });\nvar PublicRoutes = [\n    {\n        path: \"/\",\n        name: \"home\",\n        redirect: \"/login\",\n    },\n    {\n        path: \"/login\",\n        name: \"home.login\",\n        component: function () { return __webpack_require__.e(/*! import() */ 7).then(__webpack_require__.bind(null, /*! @/modules/Login/index.vue */ \"./src/modules/Login/index.vue\")); },\n    },\n    {\n        path: \"/callback\",\n        name: \"home.callback\",\n        component: function () { return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! @/modules/Callback/index.vue */ \"./src/modules/Callback/index.vue\")); },\n    },\n];\n\n\n//# sourceURL=webpack:///./src/routes/PublicRoutes.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"store\", function() { return store; });\n/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vuex */ \"./node_modules/vuex/dist/vuex.esm-browser.js\");\n/* harmony import */ var _util_version__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/util/version */ \"./src/util/version.ts\");\n\n\nvar STORAGE_KEY = \"boto\";\nvar AUTH_TOKEN_KEY = \"boto-auth-token\";\nvar LOCALE_KEY = \"boto-locale\";\nvar APP_VERSION_KEY = \"boto-version\";\nvar defaultLocale = \"en\";\nvar store = Object(vuex__WEBPACK_IMPORTED_MODULE_0__[\"createStore\"])({\n    strict: \"demo\" === \"development\",\n    state: {\n        authToken: localStorage.getItem(AUTH_TOKEN_KEY) || \"\",\n        locale: localStorage.getItem(LOCALE_KEY) || defaultLocale,\n    },\n    getters: {\n        localStorageState: function () {\n            return JSON.parse(localStorage.getItem(STORAGE_KEY) || \"{}\");\n        },\n        localStorageLocale: function () {\n            return localStorage.getItem(LOCALE_KEY) || \"\";\n        },\n        localStorageAuthToken: function () {\n            return localStorage.getItem(AUTH_TOKEN_KEY) || \"\";\n        },\n        localStorageAppVersion: function () {\n            return localStorage.getItem(APP_VERSION_KEY) || \"\";\n        },\n    },\n    mutations: {\n        initialize: function (state, initialState) {\n            var localVersion = localStorage.getItem(APP_VERSION_KEY);\n            var localCfg = localStorage.getItem(STORAGE_KEY);\n            if (!localVersion || localVersion !== _util_version__WEBPACK_IMPORTED_MODULE_1__[\"default\"] || !localCfg) {\n                state = initialState;\n                localStorage.setItem(STORAGE_KEY, JSON.stringify(initialState));\n                localStorage.setItem(APP_VERSION_KEY, _util_version__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\n            }\n        },\n        setAuthToken: function (state, token) {\n            state.authToken = token;\n            localStorage.setItem(AUTH_TOKEN_KEY, token.toString());\n        },\n        saveLocale: function (state, locale) {\n            state.locale = locale;\n            localStorage.setItem(LOCALE_KEY, locale);\n        },\n    },\n});\n\n\n//# sourceURL=webpack:///./src/store/index.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// generated by genversion\n/* harmony default export */ __webpack_exports__[\"default\"] = (\"0.0.14\");\n\n\n//# sourceURL=webpack:///./src/util/version.ts?");
